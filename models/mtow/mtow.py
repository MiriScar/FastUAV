...
class MtowCalculation(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        if MR_PROPULSION in propulsion_id_list:
            ...
            self.add_input("data:weight:airframe:landing_gear:mass", val=0.0, units="kg")            
    ...
    def compute(self, inputs, outputs):
        ...
        if MR_PROPULSION in propulsion_id_list:
            mtow += (inputs["data:weight:airframe:body:mass"]
                     ...
                     + inputs["data:weight:airframe:landing_gear:mass"])
    ...
    def compute_partials(self, inputs, partials, discrete_inputs=None):
        ...
        if MR_PROPULSION in propulsion_id_list:
            ...
            partials["data:weight:mtow",
                    "data:weight:airframe:landing_gear:mass"] = 1.0
